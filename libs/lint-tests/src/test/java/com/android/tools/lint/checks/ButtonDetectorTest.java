...
public class ButtonDetectorTest extends AbstractCheckTest {
    ...
    public void testButtonOrder5() throws Exception {
        ...
        assertEquals(
            ...
            lintProject(
                    mMinsdk5targetsdk14,
                    mButtonbar,
                    xml("res/layout-v14/buttonbar.xml", ""
    ...
    public void testSuppressed() throws Exception {
        ...
        assertEquals(
            ...
            lintProject(
                    manifest().minSdk(14),
                    xml("res/layout/buttonbar_suppressed.xml", ""
                            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                            + "<LinearLayout xmlns:android=\"http://schemas.android.com/apk/res/android\"\n"
    ...
    public void testButtonOrderRelativeLayout() throws Exception {
        ...
        assertEquals(
            ...
            lintProject(mButtonbar2_class, mButtonbar_values));
    }
    ...
    public void testButtonOrderRelativeLayout3() throws Exception {
        ...
        assertEquals(
            ...
            lintProject(xml("res/layout/buttonbar4.xml", ""
                            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
    ...
    private TestFile mButtonbar = xml("res/layout/buttonbar.xml", ""
            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
            + "<LinearLayout xmlns:android=\"http://schemas.android.com/apk/res/android\"\n"
            + "    android:layout_width=\"match_parent\"\n"
            + "    android:layout_height=\"match_parent\"\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mButtonbar2 = xml("res/layout-v14/buttonbar.xml", ""
            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
            + "<LinearLayout xmlns:android=\"http://schemas.android.com/apk/res/android\"\n"
            + "    android:layout_width=\"match_parent\"\n"
            + "    android:layout_height=\"match_parent\"\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mButtonbar2_class = xml("res/layout/buttonbar2.xml", ""
            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
            + "<RelativeLayout xmlns:android=\"http://schemas.android.com/apk/res/android\"\n"
            + "    android:layout_width=\"wrap_content\"\n"
            + "    android:layout_height=\"wrap_content\" >\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mButtonbar3 = xml("res/layout-v16/buttonbar.xml", ""
            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
            + "<LinearLayout xmlns:android=\"http://schemas.android.com/apk/res/android\"\n"
            + "    android:layout_width=\"match_parent\"\n"
            + "    android:layout_height=\"match_parent\"\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mButtonbar3_class = xml("res/layout/buttonbar3.xml", ""
            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
            + "<LinearLayout xmlns:android=\"http://schemas.android.com/apk/res/android\"\n"
            + "    android:layout_width=\"match_parent\"\n"
            + "    android:layout_height=\"wrap_content\"\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mButtonbar4 = xml("res/layout-en-rGB/buttonbar.xml", ""
            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
            + "<LinearLayout xmlns:android=\"http://schemas.android.com/apk/res/android\"\n"
            + "    android:layout_width=\"match_parent\"\n"
            + "    android:layout_height=\"match_parent\"\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mButtonbar5 = xml("res/layout-de/buttonbar.xml", ""
            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
            + "<LinearLayout xmlns:android=\"http://schemas.android.com/apk/res/android\"\n"
            + "    android:layout_width=\"match_parent\"\n"
            + "    android:layout_height=\"match_parent\"\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mButtonbar_values = xml("res/values/buttonbar-values.xml", ""
            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
            + "<resources>\n"
            + "\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mButtonbar_values2 = xml("res/values-en-rGB/buttonbar-values.xml", ""
            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
            + "<resources>\n"
            + "\n"
            + "    <string name=\"button\"> Button </string>\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mButtonbar_values3 = xml("res/values-de/buttonbar-values.xml", ""
            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
            + "<resources>\n"
            + "\n"
            + "    <string name=\"button\"> Button </string>\n"
